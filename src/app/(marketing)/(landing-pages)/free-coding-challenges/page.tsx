...
export default function FreeCodingChallengesPage() {
  const jsonLd: WebPageJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: `${getBaseUrl()}/free-coding-challenges`,
    headline: 'Free Coding Challenges | BizLevel',
    description:
      'Master coding with BizLevel’s free coding challenges. Learn JavaScript, web development, and programming through real-world challenges tailored to your skill level.',
    image:
    ...
    breadcrumb: {
      ...
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Home', item: `${getBaseUrl()}` },
        {
          '@type': 'ListItem',
          position: 2,
          name: 'Free Coding Challenges',
          item: `${getBaseUrl()}/free-coding-challenges`,
        },
      ],
    },
    author: {
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `${getBaseUrl()}/free-coding-challenges`,
    },
    keywords:
      'free coding challenges, free JavaScript challenges, learn to code for free, free web development challenges, free coding practice, free programming challenges, free coding for beginners',
    publisher: {
    ...
    <>
      ...
      <div className="container">
        <FeatureDailyChallengeHero
          ...
          animatedSpan="Learn to code for free"
        />
        ...
        <MarketingContentGrid title="Everything You Need to Learn to Code for Free" items={items} />

        <FAQsBlock faqs={faqs} />

        <CallToActionBlock
          title="Start Learning to Code for Free Today"
