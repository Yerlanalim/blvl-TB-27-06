...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const { frontmatter } = await getBlogPost(
    ...
    return createMetadata({
      ...
      canonicalUrl: `/javascript-coding-interview-questions-and-answers/javascript-interview-questions-for-senior-developers`,
    });
  } catch {
    return {
...
export default async function JavascriptInterviewQuestionsForSeniorDevelopers({
  params,
}: BlogPostParams) {
  try {
