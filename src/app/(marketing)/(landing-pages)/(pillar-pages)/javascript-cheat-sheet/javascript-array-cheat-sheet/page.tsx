...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const { frontmatter } = await getBlogPost('javascript-array-cheat-sheet');
    ...
    return createMetadata({
      ...
      canonicalUrl: `/javascript-cheat-sheet/javascript-array-cheat-sheet`,
    });
  } catch {
    return {
...
export default async function JavascriptArrayCheatSheet({ params }: BlogPostParams) {
  try {
    const { content, frontmatter } = await getBlogPost('javascript-array-cheat-sheet');
