...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const { frontmatter } = await getBlogPost('primitive-types-in-javascript');
    ...
    return createMetadata({
      ...
      canonicalUrl: `/javascript-fundamentals/primitive-types-in-javascript`,
    });
  } catch {
    return {
...
export default async function PrimitiveTypesInJavascript({ params }: BlogPostParams) {
  try {
    const { content, frontmatter } = await getBlogPost('primitive-types-in-javascript');
