...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const { frontmatter } = await getBlogPost('how-to-write-a-function-in-javascript');
    ...
    return createMetadata({
      ...
      canonicalUrl: `/javascript-fundamentals/how-to-write-a-function-in-javascript`,
    });
  } catch {
    return {
...
export default async function HowToWriteAFunctionInJavascript({ params }: BlogPostParams) {
  try {
    const { content, frontmatter } = await getBlogPost('how-to-write-a-function-in-javascript');
