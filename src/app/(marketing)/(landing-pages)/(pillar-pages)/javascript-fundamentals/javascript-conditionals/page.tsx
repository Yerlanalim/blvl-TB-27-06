...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const { frontmatter } = await getBlogPost('javascript-conditionals');
    ...
    return createMetadata({
      ...
      canonicalUrl: `/javascript-fundamentals/javascript-conditionals`,
    });
  } catch {
    return {
...
export default async function JavaScriptConditionals({ params }: BlogPostParams) {
  try {
    const { content, frontmatter } = await getBlogPost('javascript-conditionals');
