...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const { frontmatter } = await getBlogPost('html-conditional-statement');
    ...
    return createMetadata({
      ...
      canonicalUrl: `/javascript-fundamentals/html-conditional-statement`,
    });
  } catch {
    return {
...
export default async function HtmlConditionalStatement({ params }: BlogPostParams) {
  try {
    const { content, frontmatter } = await getBlogPost('html-conditional-statement');
