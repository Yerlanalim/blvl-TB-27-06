...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const { frontmatter } = await getBlogPost('javascript-nested-conditionals');
    ...
    return createMetadata({
      ...
      canonicalUrl: `/javascript-fundamentals/javascript-nested-conditionals`,
    });
  } catch {
    return {
...
export default async function JavaScriptNestedConditionals({ params }: BlogPostParams) {
  try {
    const { content, frontmatter } = await getBlogPost('javascript-nested-conditionals');
