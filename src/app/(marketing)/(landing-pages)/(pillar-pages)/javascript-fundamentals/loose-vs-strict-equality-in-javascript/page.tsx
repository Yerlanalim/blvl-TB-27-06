...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const { frontmatter } = await getBlogPost('loose-vs-strict-equality-in-javascript');
    ...
    return createMetadata({
      ...
      canonicalUrl: `/javascript-fundamentals/loose-vs-strict-equality-in-javascript`,
    });
  } catch {
    return {
...
export default async function LooseVsStrictEqualityInJavascript({ params }: BlogPostParams) {
  try {
    const { content, frontmatter } = await getBlogPost('loose-vs-strict-equality-in-javascript');
