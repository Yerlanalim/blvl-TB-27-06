...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const { frontmatter } = await getBlogPost('javascript-naming-conventions');
    ...
    return createMetadata({
      ...
      canonicalUrl: `/javascript-fundamentals/javascript-naming-conventions`,
    });
  } catch {
    return {
...
export default async function JavaScriptNamingConventions({ params }: BlogPostParams) {
  try {
    const { content, frontmatter } = await getBlogPost('javascript-naming-conventions');
