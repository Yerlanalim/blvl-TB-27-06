...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const { frontmatter } = await getBlogPost('how-to-convert-a-number-to-string-in-javascript');
    ...
    return createMetadata({
      ...
      canonicalUrl: `/javascript-fundamentals/how-to-convert-a-number-to-string-in-javascript`,
    });
  } catch {
    return {
...
export default async function HowToConvertANumberToStringInJavascript({ params }: BlogPostParams) {
  try {
