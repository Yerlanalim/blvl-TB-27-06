...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const { frontmatter } = await getBlogPost('how-does-javascript-work');
    ...
    return createMetadata({
      ...
      canonicalUrl: `/javascript-fundamentals/how-does-javascript-work`,
    });
  } catch {
    return {
...
export default async function HowDoesJavascriptWork({ params }: BlogPostParams) {
  try {
    const { content, frontmatter } = await getBlogPost('how-does-javascript-work');
