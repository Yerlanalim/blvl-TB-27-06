...
<CodeSnippet code={`// Using regex literal

const regexLiteral = /pattern/;

// Using RegExp constructor

const regexConstructor = new RegExp('pattern');`} language="js" filename="js-1.js" />
...
<CodeSnippet code={`const regex = /hello/;

const str = 'hello world';

console.log(regex.test(str)); // true

console.log(regex.exec(str)); // ['hello', index: 0, input: 'hello world']`} language="js" filename="js-2.js" />
...
<CodeSnippet code={`const str = 'Hello, world!';

const newStr = str.replace(/world/, 'JavaScript');

console.log(newStr); // 'Hello, JavaScript!'`} language="js" filename="js-3.js" />
...
<CodeSnippet code={`const str = 'apple,banana,grape';

const fruits = str.split(/,/);

console.log(fruits); // ['apple', 'banana', 'grape']`} language="js" filename="js-4.js" />
...
<CodeSnippet code={`const regex = /hello/gi;

const str = 'Hello, hello, HELLO!';

console.log(str.match(regex)); // ['Hello', 'hello', 'HELLO']`} language="js" filename="js-5.js" />
...
<CodeSnippet code={`const emailRegex = /^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$/;

const email = 'test@example.com';



console.log(emailRegex.test(email)); // true`} language="js" filename="js-6.js" />
...
console.log(str.match(regex)); // ['Hello', 'hello', 'HELLO']`} language="js" filename="js-7.js" />
...
<CodeSnippet code={`const dateRegex = /(\\d{4})-(\\d{2})-(\\d{2})/;

const date = '2024-02-06';

const match = dateRegex.exec(date);

console.log(match); // ['2024-02-06', '2024', '02', '06']`} language="js" filename="js-8.js" />
...
<CodeSnippet code={`const safeRegex = (pattern, str) => {
  try {
...
console.log(safeRegex('[a-z', 'test')); // Invalid regex pattern`} language="js" filename="js-9.js" />
...
<CodeSnippet code={`// Avoid nested quantifiers
...
console.timeEnd('fastRegex'); // Faster`} language="js" filename="js-10.js" />
...
BizLevel is the best site to learn JavaScript. Our free course teaches you HTML, CSS, and JavaScript, ensuring you learn the basics and become a better JavaScript developer in no time!