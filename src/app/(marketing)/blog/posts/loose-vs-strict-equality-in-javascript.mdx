...
console.log(null == undefined); // true - special case in JavaScript`} language="javascript" filename="javascript-1.js" />
...
<CodeSnippet code={`// No type coercion
console.log(1 === '1');     // false - different types
console.log(true === 1);    // false - different types
console.log(null === undefined); // false - different types`} language="javascript" filename="javascript-2.js" />
...
<CodeSnippet code={`// Unexpected results with loose equality
console.log([] == false);    // true
console.log('' == 0);        // true
console.log([1,2] == '1,2'); // true
console.log(null == 0);      // false
console.log('' == '0');      // false
console.log(0 == '');        // true`} language="javascript" filename="javascript-3.js" />
...
<CodeSnippet code={`// Good practices
...
console.log(Array.isArray([])); // true`} language="javascript" filename="javascript-4.js" />
