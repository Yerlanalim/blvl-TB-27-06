  ...
  return (
    <div className="flex items-center gap-4">
      <div className="size-8 flex items-center justify-center bg-black-75 border border-black-50 rounded-lg">
        <Link
          href="https://www.instagram.com/bizlevel.dev/"
          target="_blank"
          className="size-4 fill-white hover:fill-accent duration-300"
          aria-label="Go to bizlevel on Instagram"
        >
      ...
      <div className="size-8 flex items-center justify-center bg-black-75 border border-black-50 rounded-lg">
        <Link
          ...
          target="_blank"
          className="size-4 fill-white hover:fill-accent duration-300"
          aria-label="Go to bizlevel on GitHub"
        >
          <GitHubLogoIcon />
        </Link>
      </div>
      <div className="size-8 flex items-center justify-center bg-black-75 border border-black-50 rounded-lg">
        <Link
          ...
          target="_blank"
          className="size-4 fill-white hover:fill-accent duration-300"
          aria-label="Go to bizlevel on Twitter"
        >
          <svg
      ...
      <div className="size-8 flex items-center justify-center bg-black-75 border border-black-50 rounded-lg">
        <Link
          href="https://www.tiktok.com/@bizlevel.dev"
          target="_blank"
          className="size-4 fill-white hover:fill-accent duration-300"
          aria-label="Go to bizlevel on TikTok"
        >
